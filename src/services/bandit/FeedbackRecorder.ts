...
const REWARD_SIGNALS = new Set(['semantic_inject_hit', 'search_accessed', 'context_referenced']);

/** Weighted rewards: higher-quality signals get more bandit reward */
const SIGNAL_REWARD_WEIGHT: Record<string, number> = {
  'semantic_inject_hit': 0.3,
  'search_accessed': 0.5,
  'context_referenced': 1.0,
};
