"use strict";var vt=Object.create;var G=Object.defineProperty;var yt=Object.getOwnPropertyDescriptor;var Ut=Object.getOwnPropertyNames;var xt=Object.getPrototypeOf,wt=Object.prototype.hasOwnProperty;var kt=(r,e)=>{for(var t in e)G(r,t,{get:e[t],enumerable:!0})},Re=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Ut(e))!wt.call(r,n)&&n!==t&&G(r,n,{get:()=>e[n],enumerable:!(s=yt(e,n))||s.enumerable});return r};var U=(r,e,t)=>(t=r!=null?vt(xt(r)):{},Re(e||!r||!r.__esModule?G(t,"default",{value:r,enumerable:!0}):t,r)),Ft=r=>Re(G({},"__esModule",{value:!0}),r);var _s={};kt(_s,{generateContext:()=>be});module.exports=Ft(_s);var Lt=U(require("path"),1),Mt=require("os"),Dt=require("fs");var oe=require("bun:sqlite");var g=require("path"),te=require("os"),D=require("fs");var Ne=require("url");var L=require("fs"),Ae=require("path");var Z=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(Z||{}),ee=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=x.logsDir();(0,L.existsSync)(e)||(0,L.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,Ae.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=x.settings();if((0,L.existsSync)(e)){let t=(0,L.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=Z[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`}function mt(r,e,t,s){let n=[];s?n.push(...Ze(r)):n.push(...$e(r));let o=t.fetchByIdSupported!==!1;return s?n.push(...et()):n.push(...He(o)),s?n.push(...tt()):n.push(...Ge()),s?n.push(...st(o)):n.push(...Xe()),Y(t)&&(s?n.push(...rt(e,t)):n.push(...je(e,t))),n}var ce=U(require("path"),1);function Q(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return u.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e instanceof Error?e:new Error(String(e))),[]}}function me(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function le(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function pt(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function lt(r,e){return ce.default.isAbsolute(r)?ce.default.relative(e,r):r}function Et(r,e,t){let s=Q(r);if(s.length>0)return lt(s[0],e);if(t){let n=Q(t);if(n.length>0)return lt(n[0],e)}return"General"}function es(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=pt(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function gt(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?Q(r.facts).join(`
`):null}function ts(r,e,t,s){let n=[];n.push(...Be(r));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=me(a.displayTime);n.push(...Ye(a,d))}else{let a=i.data,d=le(a.created_at),c=d!==o?d:"";if(o=d,t.has(a.id)){let p=gt(a,s);n.push(...qe(a,c,p,s))}else n.push(Ve(a,c,s))}return n}function ss(r,e,t,s,n){let o=[];o.push(...nt(r));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let m=d.data,c=me(m.displayTime);o.push(...dt(m,c))}else{let m=d.data,c=Et(m.files_modified,n,m.files_read),T=le(m.created_at),p=T!==a;a=T;let E=t.has(m.id);if(c!==i&&(o.push(...ot(c)),i=c),E){let f=gt(m,s);o.push(...at(m,T,p,f,s))}else o.push(it(m,T,p,s))}return o.push(""),o}function rs(r,e,t,s,n,o){return o?ss(r,e,t,s,n):ts(r,e,t,s)}function Tt(r,e,t,s,n){let o=[],i=es(r);for(let[a,d]of i)o.push(...rs(a,d,e,t,s,n));return o}function ft(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function St(r,e){let t=[];return e?(t.push(...H("Investigated",r.investigated,_.blue)),t.push(...H("Learned",r.learned,_.yellow)),t.push(...H("Completed",r.completed,_.green)),t.push(...H("Next Steps",r.next_steps,_.magenta))):(t.push(...$("Investigated",r.investigated)),t.push(...$("Learned",r.learned)),t.push(...$("Completed",r.completed)),t.push(...$("Next Steps",r.next_steps))),t}function bt(r,e){return e?_t(r):Ke(r)}function ht(r,e,t){return!Y(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?ut(r.totalDiscoveryTokens,r.totalReadTokens):Je(r.totalDiscoveryTokens,r.totalReadTokens)}function ns(r){return r.replace(/\//g,"-")}function os(r){if(!r.includes('"type":"assistant"'))return null;let e=JSON.parse(r);if(e.type==="assistant"&&e.message?.content&&Array.isArray(e.message.content)){let t="";for(let s of e.message.content)s.type==="text"&&(t+=s.text);if(t=t.replace(Fe,"").trim(),t)return t}return null}function is(r){for(let e=r.length-1;e>=0;e--)try{let t=os(r[e]);if(t)return t}catch(t){t instanceof Error?u.debug("WORKER","Skipping malformed transcript line",{lineIndex:e},t):u.debug("WORKER","Skipping malformed transcript line",{lineIndex:e,error:String(t)});continue}return""}function Rt(r){try{if(!(0,z.existsSync)(r))return{userMessage:"",assistantMessage:""};let e=(0,z.readFileSync)(r,"utf-8").trim();if(!e)return{userMessage:"",assistantMessage:""};let t=e.split(`
`).filter(n=>n.trim());return{userMessage:"",assistantMessage:is(t)}}catch(e){return e instanceof Error?u.failure("WORKER","Failed to extract prior messages from transcript",{transcriptPath:r},e):u.warn("WORKER","Failed to extract prior messages from transcript",{transcriptPath:r,error:String(e)}),{userMessage:"",assistantMessage:""}}}function pe(r,e,t,s){if(!e.showLastMessage||r.length===0)return{userMessage:"",assistantMessage:""};let n=r.find(d=>d.memory_session_id!==t);if(!n)return{userMessage:"",assistantMessage:""};let o=n.memory_session_id,i=ns(s),a=Ot.default.join(v,"projects",i,`${o}.jsonl`);return Rt(a)}function At(r,e){let t=e[0]?.id;return r.map((s,n)=>{let o=n===0?null:e[n+1];return{...s,displayEpoch:o?o.created_at_epoch:s.created_at_epoch,displayTime:o?o.created_at:s.created_at,shouldShowLink:s.id!==t}})}function Ee(r,e){let t=[...r.map(s=>({type:"observation",data:s})),...e.map(s=>({type:"summary",data:s}))];return t.sort((s,n)=>{let o=s.type==="observation"?s.data.created_at_epoch:s.data.displayEpoch,i=n.type==="observation"?n.data.created_at_epoch:n.data.displayEpoch;return o-i}),t}function Nt(r,e){return new Set(r.slice(0,e).map(t=>t.id))}function ge(r,e){return e?ct(r):Qe(r)}function Te(r,e,t,s,n,o,i){let a=[],d=ue(e);a.push(...mt(r,d,s,i));let m=t.slice(0,s.sessionCount),c=At(m,t),T=Ee(e,c),p=Nt(e,s.fullObservationCount);a.push(...Tt(T,p,s,n,i));let E=t[0],f=e[0];ft(s,E,f)&&a.push(...St(E,i));let b=pe(e,s,o,n);return a.push(...bt(b,i)),a.push(...ht(d,s,i)),a.join(`
`).trimEnd()}function fe(r,e,t){let s=Array.from(t.observationTypes),n=s.map(()=>"?").join(","),o=Array.from(t.observationConcepts),i=o.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
      o.id,
      o.memory_session_id,
    ...
    ORDER BY o.created_at_epoch DESC
    LIMIT ?
  `).all(e,e,...s,...o,t.totalObservationCount)}function Se(r,e,t){return r.db.prepare(`
    SELECT
      ss.id,
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(e,e,t.sessionCount+de)}function Ct(r,e,t){let s=Array.from(t.observationTypes),n=s.map(()=>"?").join(","),o=Array.from(t.observationConcepts),i=o.map(()=>"?").join(","),a=e.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
      o.id,
      o.memory_session_id,
      COALESCE(s.platform_source, 'claude') as platform_source,
  ...
  `).all(...e,...e,...s,...o,t.totalObservationCount)}function It(r,e,t){let s=e.map(()=>"?").join(",");return r.db.prepare(`
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(...e,...e,t.sessionCount+de)}var as=Lt.default.join((0,Mt.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function ds(){try{return new W}catch(r){if(r instanceof Error&&r.code==="ERR_DLOPEN_FAILED"){try{(0,Dt.unlinkSync)(as)}catch(e){e instanceof Error?u.debug("WORKER","Marker file cleanup failed (may not exist)",{},e):u.debug("WORKER","Marker file cleanup failed (may not exist)",{error:String(e)})}return u.error("WORKER","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}async function be(r,e=!1){let t=ae(),s=r?.cwd??process.cwd(),n=re(s),o=r?.projects?.length?r.projects:n.allProjects,i=o[o.length-1]??n.primary;r?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let a=ds();if(!a)return"";try{let d=o.length>1?Ct(a,o,t):fe(a,i,t),m=o.length>1?It(a,o,t):Se(a,i,t);return d.length===0&&m.length===0?ge(i,e):Te(i,d,m,t,s,r?.session_id,e)}finally{a.close()}}0&&(module.exports={generateContext});
