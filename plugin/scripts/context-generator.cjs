"use strict";var Rt=Object.create;var w=Object.defineProperty;var Nt=Object.getOwnPropertyDescriptor;var Ct=Object.getOwnPropertyNames;var It=Object.getPrototypeOf,Lt=Object.prototype.hasOwnProperty;var Dt=(r,e)=>{for(var t in e)w(r,t,{get:e[t],enumerable:!0})},le=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Ct(e))!Lt.call(r,n)&&n!==t&&w(r,n,{get:()=>e[n],enumerable:!(s=Nt(e,n))||s.enumerable});return r};var M=(r,e,t)=>(t=r!=null?Rt(It(r)):{},le(e||!r||!r.__esModule?w(t,"default",{value:r,enumerable:!0}):t,r)),yt=r=>le(w({},"__esModule",{value:!0}),r);var Qt={};Dt(Qt,{generateContext:()=>me});module.exports=yt(Qt);var bt=M(require("path"),1),ht=require("os"),At=require("fs");var Oe=require("bun:sqlite");var f=require("path"),Z=require("os"),P=require("fs");var Te=require("url");var I=require("fs"),v=require("path"),ge=require("os"),z=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(z||{}),Ee=(0,v.join)((0,ge.homedir)(),".claude-mem"),Q=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=(0,v.join)(Ee,"logs");(0,I.existsSync)(e)||(0,I.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,v.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=(0,v.join)(Ee,"settings.json");if((0,I.existsSync)(e)){let t=(0,I.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=z[n]??1}else this.level=1}catch{this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),m=_?`${_[1].split("/").pop()}:${_[2]}`:"unknown",l={...s,location:m};return this.warn(e,`[HAPPY-PATH] ${t}`,l,n),o}},u=new Q;var xt={};function Mt(){return typeof __dirname<"u"?__dirname:(0,f.dirname)((0,Te.fileURLToPath)(xt.url))}var vt=Mt();function Ut(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,f.join)((0,Z.homedir)(),".claude-mem"),e=(0,f.join)(r,"settings.json");try{if((0,P.existsSync)(e)){let{readFileSync:t}=require("fs"),s=JSON.parse(t(e,"utf-8")),n=s.env??s;if(n.CLAUDE_MEM_DATA_DIR)return n.CLAUDE_MEM_DATA_DIR}}catch{}return r}var N=Ut(),D=process.env.CLAUDE_CONFIG_DIR||(0,f.join)((0,Z.homedir)(),".claude"),rs=(0,f.join)(D,"plugins","marketplaces","thedotmack"),ns=(0,f.join)(N,"archives"),os=(0,f.join)(N,"logs"),is=(0,f.join)(N,"trash"),as=(0,f.join)(N,"backups"),ds=(0,f.join)(N,"modes"),cs=(0,f.join)(N,"settings.json"),fe=(0,f.join)(N,"claude-mem.db"),_s=(0,f.join)(N,"vector-db"),us=(0,f.join)(N,"observer-sessions"),ms=(0,f.join)(D,"settings.json"),ps=(0,f.join)(D,"commands"),ls=(0,f.join)(D,"CLAUDE.md");function Se(r){(0,P.mkdirSync)(r,{recursive:!0})}function be(){return(0,f.join)(vt,"..")}var he=require("crypto");var kt=3e4;function H(r,e,t){return(0,he.createHash)("sha256").update([r||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}function j(r,e,t){let s=t-kt;return r.prepare("SELECT id, created_at_epoch FROM observations WHERE content_hash = ? AND created_at_epoch > ?").get(e,s)}function ee(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[String(e)]}catch{return[r]}}var h="claude";function $t(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function y(r){if(!r)return h;let e=$t(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:h}function Ae(r){let e=["claude","codex","cursor"];return[...r].sort((t,s)=>{let n=e.indexOf(t),o=e.indexOf(s);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:t.localeCompare(s)})}function Ft(r,e){return{customTitle:r,platformSource:e?y(e):void 0}}var X=class{db;constructor(e=fe){e!==":memory:"&&Se(N),this.db=new Oe.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns()}initializeSchema(){this.db.run(`
    ...
    `).all(e)}getObservationById(e){return this.db.prepare(`
      ...
      FROM observations
      WHERE id = ?
    `).get(e)||null}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,type:i,concepts:a,files:d}=t,_=s==="date_asc"?"ASC":"DESC",m=n?`LIMIT ${n}`:"",l=e.map(()=>"?").join(","),E=[...e],T=[];if(o&&(T.push("project = ?"),E.push(o)),i)if(Array.isArray(i)){let p=i.map(()=>"?").join(",");T.push(`type IN (${p})`),E.push(...i)}else T.push("type = ?"),E.push(i);if(a){let p=Array.isArray(a)?a:[a],O=p.map(()=>"EXISTS (SELECT 1 FROM json_each(concepts) WHERE value = ?)");E.push(...p),T.push(`(${O.join(" OR ")})`)}if(d){let p=Array.isArray(d)?d:[d],O=p.map(()=>"(EXISTS (SELECT 1 FROM json_each(files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(files_modified) WHERE value LIKE ?))");p.forEach(g=>{E.push(`%${g}%`,`%${g}%`)}),T.push(`(${O.join(" OR ")})`)}let A=T.length>0?`WHERE id IN (${l}) AND ${T.join(" AND ")}`:`WHERE id IN (${l})`;return this.db.prepare(`
      SELECT *
      FROM observations
      ${A}
    ...
    `).get(e).count}createSDKSession(e,t,s,n,o){let i=new Date,a=i.getTime(),d=Ft(n,o),_=d.platformSource??h,m=this.db.prepare(`
    ...
    `).run(e,t,s,n.toISOString(),o).lastInsertRowid}getUserPrompt(e,t){return this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,o=0,i,a){let d=i??Date.now(),_=new Date(d).toISOString(),m=H(e,s.title,s.narrative),l=j(this.db,m,d);if(l)return{id:l.id,createdAtEpoch:l.created_at_epoch};let T=this.db.prepare(`
    ...
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,o,d,a);return{id:Number(m.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,o,i=0,a,d){let _=a??Date.now(),m=new Date(_).toISOString();return this.db.transaction(()=>{let E=[],T=this.db.prepare(`
      ...
      `);for(let S of s){let p=H(e,S.title,S.narrative),O=j(this.db,p,_);if(O){E.push(O.id);continue}let g=T.run(e,t,S.type,S.title,S.subtitle,JSON.stringify(S.facts),S.narrative,JSON.stringify(S.concepts),JSON.stringify(S.files_read),JSON.stringify(S.files_modified),o||null,i,p,m,_,d||null);E.push(Number(g.lastInsertRowid))}let A=null;if(n){let p=this.db.prepare(`
        ...
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         ...
         generated_by_model)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let g of s){let b=H(e,g.title,g.narrative),pe=j(this.db,b,l);if(pe){A.push(pe.id);continue}let Ot=S.run(e,t,g.type,g.title,g.subtitle,JSON.stringify(g.facts),g.narrative,JSON.stringify(g.concepts),JSON.stringify(g.files_read),JSON.stringify(g.files_modified),a||null,d,b,E,l,m||null);A.push(Number(Ot.lastInsertRowid))}let p;if(n){let b=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
  ...
  `).all(...e,...n,...i,...s?[s]:[],t.totalObservationCount)}function ke(r,e,t,s){let n=e.map(()=>"?").join(",");return r.db.prepare(`
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(...e,...s?[s]:[],t.sessionCount+re)}function Ht(r){return r.replace(/\//g,"-")}function jt(r){try{if(!(0,V.existsSync)(r))return{userMessage:"",assistantMessage:""};let e=(0,V.readFileSync)(r,"utf-8").trim();if(!e)return{userMessage:"",assistantMessage:""};let t=e.split(`
`).filter(n=>n.trim()),s="";for(let n=t.length-1;n>=0;n--)try{let o=t[n];if(!o.includes('"type":"assistant"'))continue;let i=JSON.parse(o);if(i.type==="assistant"&&i.message?.content&&Array.isArray(i.message.content)){let a="";for(let d of i.message.content)d.type==="text"&&(a+=d.text);if(a=a.replace(ve,"").trim(),a){s=a;break}}}catch(o){u.debug("PARSER","Skipping malformed transcript line",{lineIndex:n},o);continue}return{userMessage:"",assistantMessage:s}}catch(e){return u.failure("WORKER","Failed to extract prior messages from transcript",{transcriptPath:r},e),{userMessage:"",assistantMessage:""}}}function _e(r,e,t,s){if(!e.showLastMessage||r.length===0)return{userMessage:"",assistantMessage:""};let n=r.find(d=>d.memory_session_id!==t);if(!n)return{userMessage:"",assistantMessage:""};let o=n.memory_session_id,i=Ht(s),a=Ue.default.join(D,"projects",i,`${o}.jsonl`);return jt(a)}function $e(r,e){let t=e[0]?.id;return r.map((s,n)=>{let o=n===0?null:e[n+1];return{...s,displayEpoch:o?o.created_at_epoch:s.created_at_epoch,displayTime:o?o.created_at:s.created_at,shouldShowLink:s.id!==t}})}function ue(r,e){let t=[...r.map(s=>({type:"observation",data:s})),...e.map(s=>({type:"summary",data:s}))];return t.sort((s,n)=>{let o=s.type==="observation"?s.data.created_at_epoch:s.data.displayEpoch,i=n.type==="observation"?n.data.created_at_epoch:n.data.displayEpoch;return o-i}),t}function Fe(r,e){return new Set(r.slice(0,e).map(t=>t.id))}function we(r,e){let t=e.map(()=>"?").join(","),s=r.db.prepare(`
    SELECT
      COUNT(*) AS total_obs,
...
`}function pt(r,e,t,s){let n=[];return s?n.push(...et(r)):n.push(...He(r)),s?n.push(...tt()):n.push(...je()),s?n.push(...st()):n.push(...Xe()),s?n.push(...rt()):n.push(...Ge()),Y(t)&&(s?n.push(...nt(e,t)):n.push(...Be(e,t))),n}function Xt(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=L(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function lt(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?q(r.facts).join(`
`):null}function Gt(r,e,t,s){let n=[];n.push(...We(r));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=ie(a.displayTime);n.push(...Ke(a,d))}else{let a=i.data,d=ae(a.created_at),m=d!==o?d:"";if(o=d,t.has(a.id)){let E=lt(a,s);n.push(...Ve(a,m,E,s))}else n.push(qe(a,m,s))}return n}function Bt(r,e,t,s,n){let o=[];o.push(...ot(r));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let _=d.data,m=ie(_.displayTime);o.push(...ct(_,m))}else{let _=d.data,m=Me(_.files_modified,n,_.files_read),l=ae(_.created_at),E=l!==a;a=l;let T=t.has(_.id);if(m!==i&&(o.push(...it(m)),i=m),T){let A=lt(_,s);o.push(...dt(_,l,E,A,s))}else o.push(at(_,l,E,s))}return o.push(""),o}function Wt(r,e,t,s,n,o){return o?Bt(r,e,t,s,n):Gt(r,e,t,s)}function Et(r,e,t,s,n){let o=[],i=Xt(r);for(let[a,d]of i)o.push(...Wt(a,d,e,t,s,n));return o}function gt(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function Tt(r,e){let t=[];return e?(t.push(...F("Investigated",r.investigated,c.blue)),t.push(...F("Learned",r.learned,c.yellow)),t.push(...F("Completed",r.completed,c.green)),t.push(...F("Next Steps",r.next_steps,c.magenta))):(t.push(...$("Investigated",r.investigated)),t.push(...$("Learned",r.learned)),t.push(...$("Completed",r.completed)),t.push(...$("Next Steps",r.next_steps))),t}function ft(r,e){return e?_t(r):Je(r)}function St(r,e,t){return!Y(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?ut(r.totalDiscoveryTokens,r.totalReadTokens):ze(r.totalDiscoveryTokens,r.totalReadTokens)}var Yt=bt.default.join((0,ht.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function qt(){try{return new X}catch(r){if(r.code==="ERR_DLOPEN_FAILED"){try{(0,At.unlinkSync)(Yt)}catch(e){u.debug("SYSTEM","Marker file cleanup failed (may not exist)",{},e)}return u.error("SYSTEM","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function Vt(r,e){return e?mt(r):Qe(r)}function Kt(r,e){let t=[],s=e.firstDate&&e.lastDate?`Memory spans ${L(e.firstDate)} to ${L(e.lastDate)}.`:"";t.push(`${r} \u2014 ${e.totalObservations} observations across ${e.totalSessions} sessions. ${s}`.trim()),t.push("You have persistent cross-session memory. Check the Context Index below before reading files."),t.push("");let n=e.recentDecisions.length>0,o=e.topFiles.length>0;if(n){t.push("Recent decisions:");for(let i of e.recentDecisions)t.push(`- ${i.title} (${i.date})`)}if(o){let i=e.topFiles.map(a=>{let d=a.split("/");return d[d.length-1]});t.push(`Top files: ${i.join(", ")}`)}return(n||o)&&t.push(""),t}function Jt(r,e,t,s,n,o,i,a){let d=[];a&&a.totalObservations>0&&d.push(...Kt(r,a)),d.push(...pt(r,W(e),s,i));let _=[],m=W(e),l=t.slice(0,s.sessionCount),E=$e(l,t),T=ue(e,E),A=Fe(e,s.fullObservationCount);_.push(...Et(T,A,s,n,i));let S=t[0],p=e[0];gt(s,S,p)&&_.push(...Tt(S,i));let O=_e(e,s,o,n);return _.push(...ft(O,i)),_.push(...St(m,s,i)),{staticPrefix:d.join(`
`).trimEnd(),dynamicContext:_.join(`
`).trimEnd()}}async function me(r,e=!1){let t=await zt(r,e);return t.dynamicContext?`${t.staticPrefix}
${t.dynamicContext}`:t.staticPrefix}async function zt(r,e=!1){let t=se(),s=r?.cwd??process.cwd(),n=Ce(s),o=r?.platform_source,i=r?.projects||[n];r?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let a=qt();if(!a)return{staticPrefix:"",dynamicContext:""};try{let d=i.length>1?xe(a,i,t,o):de(a,n,t,o),_=i.length>1?ke(a,i,t,o):ce(a,n,t,o);if(d.length===0&&_.length===0)return{staticPrefix:Vt(n,e),dynamicContext:""};let m=we(a,i);return Jt(n,d,_,t,s,r?.session_id,e,m)}finally{a.close()}}0&&(module.exports={generateContext});
