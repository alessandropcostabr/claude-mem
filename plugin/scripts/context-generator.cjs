"use strict";var Nt=Object.create;var w=Object.defineProperty;var Rt=Object.getOwnPropertyDescriptor;var It=Object.getOwnPropertyNames;var Ct=Object.getPrototypeOf,Lt=Object.prototype.hasOwnProperty;var Dt=(r,e)=>{for(var t in e)w(r,t,{get:e[t],enumerable:!0})},le=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of It(e))!Lt.call(r,n)&&n!==t&&w(r,n,{get:()=>e[n],enumerable:!(s=Rt(e,n))||s.enumerable});return r};var M=(r,e,t)=>(t=r!=null?Nt(Ct(r)):{},le(e||!r||!r.__esModule?w(t,"default",{value:r,enumerable:!0}):t,r)),vt=r=>le(w({},"__esModule",{value:!0}),r);var Qt={};Dt(Qt,{generateContext:()=>me});module.exports=vt(Qt);var bt=M(require("path"),1),ht=require("os"),Ot=require("fs");var Ae=require("bun:sqlite");var f=require("path"),Z=require("os"),P=require("fs");var ge=require("url");var C=require("fs"),y=require("path"),Te=require("os"),z=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(z||{}),Ee=(0,y.join)((0,Te.homedir)(),".claude-mem"),Q=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=(0,y.join)(Ee,"logs");(0,C.existsSync)(e)||(0,C.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,y.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=(0,y.join)(Ee,"settings.json");if((0,C.existsSync)(e)){let t=(0,C.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=z[n]??1}else this.level=1}catch{this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`+JSON.stringify(o,null,2):m=" "+this.formatData(o));let l="";if(n){let{sessionId:g,memorySessionId:O,correlationId:S,...p}=n;Object.keys(p).length>0&&(l=` {${Object.entries(p).map(([T,b])=>`${T}=${b}`).join(", ")}}`)}let E=`[${i}] [${a}] [${d}] ${c}${s}${l}${m}`;if(this.logFilePath)try{(0,C.appendFileSync)(this.logFilePath,E+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),m=c?`${c[1].split("/").pop()}:${c[2]}`:"unknown",l={...s,location:m};return this.warn(e,`[HAPPY-PATH] ${t}`,l,n),o}},u=new Q;var xt={};function Mt(){return typeof __dirname<"u"?__dirname:(0,f.dirname)((0,ge.fileURLToPath)(xt.url))}var yt=Mt();function Ut(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,f.join)((0,Z.homedir)(),".claude-mem"),e=(0,f.join)(r,"settings.json");try{if((0,P.existsSync)(e)){let{readFileSync:t}=require("fs"),s=JSON.parse(t(e,"utf-8")),n=s.env??s;if(n.CLAUDE_MEM_DATA_DIR)return n.CLAUDE_MEM_DATA_DIR}}catch{}return r}var R=Ut(),D=process.env.CLAUDE_CONFIG_DIR||(0,f.join)((0,Z.homedir)(),".claude"),rs=(0,f.join)(D,"plugins","marketplaces","thedotmack"),ns=(0,f.join)(R,"archives"),os=(0,f.join)(R,"logs"),is=(0,f.join)(R,"trash"),as=(0,f.join)(R,"backups"),ds=(0,f.join)(R,"modes"),_s=(0,f.join)(R,"settings.json"),fe=(0,f.join)(R,"claude-mem.db"),cs=(0,f.join)(R,"vector-db"),us=(0,f.join)(R,"observer-sessions"),ms=(0,f.join)(D,"settings.json"),ps=(0,f.join)(D,"commands"),ls=(0,f.join)(D,"CLAUDE.md");function Se(r){(0,P.mkdirSync)(r,{recursive:!0})}function be(){return(0,f.join)(yt,"..")}var he=require("crypto");var kt=3e4;function X(r,e,t){return(0,he.createHash)("sha256").update([r||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}function H(r,e,t){let s=t-kt;return r.prepare("SELECT id, created_at_epoch FROM observations WHERE content_hash = ? AND created_at_epoch > ?").get(e,s)}function ee(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[String(e)]}catch{return[r]}}var h="claude";function Ft(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function v(r){if(!r)return h;let e=Ft(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:h}function Oe(r){let e=["claude","codex","cursor"];return[...r].sort((t,s)=>{let n=e.indexOf(t),o=e.indexOf(s);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:t.localeCompare(s)})}function $t(r,e){return{customTitle:r,platformSource:e?v(e):void 0}}var j=class{db;constructor(e=fe){e!==":memory:"&&Se(R),this.db=new Ae.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.createFileReadTrackingTable(),this.expandFileReadTrackingActions(),this.createObservationFeedbackTable()}initializeSchema(){this.db.run(`
    ...
    `),n||this.db.run("CREATE INDEX IF NOT EXISTS idx_sdk_sessions_platform_source ON sdk_sessions(platform_source)"),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(24,new Date().toISOString()))}addObservationModelColumns(){let e=this.db.query("PRAGMA table_info(observations)").all(),t=e.some(n=>n.name==="generated_by_model"),s=e.some(n=>n.name==="relevance_count");t&&s||(t||this.db.run("ALTER TABLE observations ADD COLUMN generated_by_model TEXT"),s||this.db.run("ALTER TABLE observations ADD COLUMN relevance_count INTEGER DEFAULT 0"),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(26,new Date().toISOString()))}createFileReadTrackingTable(){if(this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(28))return;this.db.prepare("SELECT name FROM sqlite_master WHERE type='table' AND name='file_read_tracking'").get()||(this.db.run(`
      ...
      `),this.db.run("CREATE INDEX IF NOT EXISTS idx_file_read_tracking_session ON file_read_tracking(session_id)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_file_read_tracking_created ON file_read_tracking(created_at_epoch)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_file_read_tracking_action ON file_read_tracking(action)")),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(28,new Date().toISOString())}expandFileReadTrackingActions(){if(this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(29))return;if(!this.db.prepare("SELECT name FROM sqlite_master WHERE type='table' AND name='file_read_tracking'").get()){this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(29,new Date().toISOString());return}if(this.db.prepare("SELECT sql FROM sqlite_master WHERE name='file_read_tracking'").get()?.sql?.includes("auto_enriched")){this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(29,new Date().toISOString());return}this.db.transaction(()=>{this.db.run(`
      ...
      `),this.db.run("DROP TABLE file_read_tracking"),this.db.run("ALTER TABLE file_read_tracking_v2 RENAME TO file_read_tracking"),this.db.run("CREATE INDEX IF NOT EXISTS idx_file_read_tracking_session ON file_read_tracking(session_id)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_file_read_tracking_created ON file_read_tracking(created_at_epoch)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_file_read_tracking_action ON file_read_tracking(action)")})(),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(29,new Date().toISOString())}createObservationFeedbackTable(){if(this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(30))return;this.db.prepare("SELECT name FROM sqlite_master WHERE type='table' AND name='observation_feedback'").get()||(this.db.run(`
      ...
      `),this.db.run("CREATE INDEX IF NOT EXISTS idx_obs_feedback_obs_id ON observation_feedback(observation_id)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_obs_feedback_signal ON observation_feedback(signal, created_at_epoch)")),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(30,new Date().toISOString())}updateMemorySessionId(e,t){this.db.prepare(`
      UPDATE sdk_sessions
    ...
    `).run(e,t,s,n.toISOString(),o).lastInsertRowid}getUserPrompt(e,t){return this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,o=0,i,a){let d=i??Date.now(),c=new Date(d).toISOString(),m=X(e,s.title,s.narrative),l=H(this.db,m,d);if(l)return{id:l.id,createdAtEpoch:l.created_at_epoch};let g=this.db.prepare(`
    ...
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,o,d,a);return{id:Number(m.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,o,i=0,a,d){let c=a??Date.now(),m=new Date(c).toISOString();return this.db.transaction(()=>{let E=[],g=this.db.prepare(`
        ...
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         ...
         generated_by_model)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let S of s){let p=X(e,S.title,S.narrative),A=H(this.db,p,c);if(A){E.push(A.id);continue}let T=g.run(e,t,S.type,S.title,S.subtitle,JSON.stringify(S.facts),S.narrative,JSON.stringify(S.concepts),JSON.stringify(S.files_read),JSON.stringify(S.files_modified),o||null,i,p,m,c,d||null);E.push(Number(T.lastInsertRowid))}let O=null;if(n){let p=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        ...
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         ...
         generated_by_model)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let T of s){let b=X(e,T.title,T.narrative),pe=H(this.db,b,l);if(pe){O.push(pe.id);continue}let At=S.run(e,t,T.type,T.title,T.subtitle,JSON.stringify(T.facts),T.narrative,JSON.stringify(T.concepts),JSON.stringify(T.files_read),JSON.stringify(T.files_modified),a||null,d,b,E,l,m||null);O.push(Number(At.lastInsertRowid))}let p;if(n){let b=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    ...
    ORDER BY o.created_at_epoch DESC
    LIMIT ?
  `).all(e,...n,...i,...s?[s]:[],t.totalObservationCount)}function _e(r,e,t,s){return r.db.prepare(`
    SELECT
      ss.id,
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(e,...s?[s]:[],t.sessionCount+re)}function xe(r,e,t,s){let n=Array.from(t.observationTypes),o=n.map(()=>"?").join(","),i=Array.from(t.observationConcepts),a=i.map(()=>"?").join(","),d=e.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
      o.id,
      o.memory_session_id,
      COALESCE(s.platform_source, 'claude') as platform_source,
...
`}function pt(r,e,t,s){let n=[];return s?n.push(...et(r)):n.push(...Xe(r)),s?n.push(...tt()):n.push(...He()),s?n.push(...st()):n.push(...je()),s?n.push(...rt()):n.push(...Ge()),Y(t)&&(s?n.push(...nt(e,t)):n.push(...Be(e,t))),n}function jt(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=L(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function lt(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?q(r.facts).join(`
`):null}function Gt(r,e,t,s){let n=[];n.push(...We(r));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=ie(a.displayTime);n.push(...Ke(a,d))}else{let a=i.data,d=ae(a.created_at),m=d!==o?d:"";if(o=d,t.has(a.id)){let E=lt(a,s);n.push(...Ve(a,m,E,s))}else n.push(qe(a,m,s))}return n}function Bt(r,e,t,s,n){let o=[];o.push(...ot(r));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let c=d.data,m=ie(c.displayTime);o.push(..._t(c,m))}else{let c=d.data,m=Me(c.files_modified,n,c.files_read),l=ae(c.created_at),E=l!==a;a=l;let g=t.has(c.id);if(m!==i&&(o.push(...it(m)),i=m),g){let O=lt(c,s);o.push(...dt(c,l,E,O,s))}else o.push(at(c,l,E,s))}return o.push(""),o}function Wt(r,e,t,s,n,o){return o?Bt(r,e,t,s,n):Gt(r,e,t,s)}function Et(r,e,t,s,n){let o=[],i=jt(r);for(let[a,d]of i)o.push(...Wt(a,d,e,t,s,n));return o}function Tt(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function gt(r,e){let t=[];return e?(t.push(...$("Investigated",r.investigated,_.blue)),t.push(...$("Learned",r.learned,_.yellow)),t.push(...$("Completed",r.completed,_.green)),t.push(...$("Next Steps",r.next_steps,_.magenta))):(t.push(...F("Investigated",r.investigated)),t.push(...F("Learned",r.learned)),t.push(...F("Completed",r.completed)),t.push(...F("Next Steps",r.next_steps))),t}function ft(r,e){return e?ct(r):Je(r)}function St(r,e,t){return!Y(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?ut(r.totalDiscoveryTokens,r.totalReadTokens):ze(r.totalDiscoveryTokens,r.totalReadTokens)}var Yt=bt.default.join((0,ht.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function qt(){try{return new j}catch(r){if(r.code==="ERR_DLOPEN_FAILED"){try{(0,Ot.unlinkSync)(Yt)}catch(e){u.debug("SYSTEM","Marker file cleanup failed (may not exist)",{},e)}return u.error("SYSTEM","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function Vt(r,e){return e?mt(r):Qe(r)}function Kt(r,e){let t=[],s=e.firstDate&&e.lastDate?`Memory spans ${L(e.firstDate)} to ${L(e.lastDate)}.`:"";t.push(`${r} \u2014 ${e.totalObservations} observations across ${e.totalSessions} sessions. ${s}`.trim()),t.push("You have persistent cross-session memory. Check the Context Index below before reading files."),t.push("");let n=e.recentDecisions.length>0,o=e.topFiles.length>0;if(n){t.push("Recent decisions:");for(let i of e.recentDecisions)t.push(`- ${i.title} (${i.date})`)}if(o){let i=e.topFiles.map(a=>{let d=a.split("/");return d[d.length-1]});t.push(`Top files: ${i.join(", ")}`)}return(n||o)&&t.push(""),t}function Jt(r,e,t,s,n,o,i,a){let d=[];a&&a.totalObservations>0&&d.push(...Kt(r,a)),d.push(...pt(r,W(e),s,i));let c=[],m=W(e),l=t.slice(0,s.sessionCount),E=Fe(l,t),g=ue(e,E),O=$e(e,s.fullObservationCount);c.push(...Et(g,O,s,n,i));let S=t[0],p=e[0];Tt(s,S,p)&&c.push(...gt(S,i));let A=ce(e,s,o,n);return c.push(...ft(A,i)),c.push(...St(m,s,i)),{staticPrefix:d.join(`
`).trimEnd(),dynamicContext:c.join(`
`).trimEnd()}}async function me(r,e=!1){let t=await zt(r,e);return t.dynamicContext?`${t.staticPrefix}
${t.dynamicContext}`:t.staticPrefix}async function zt(r,e=!1){let t=se(),s=r?.cwd??process.cwd(),n=Ie(s),o=r?.platform_source,i=r?.projects||[n];r?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let a=qt();if(!a)return{staticPrefix:"",dynamicContext:""};try{let d=i.length>1?xe(a,i,t,o):de(a,n,t,o),c=i.length>1?ke(a,i,t,o):_e(a,n,t,o);if(d.length===0&&c.length===0)return{staticPrefix:Vt(n,e),dynamicContext:""};let m=we(a,i);return Jt(n,d,c,t,s,r?.session_id,e,m)}finally{a.close()}}0&&(module.exports={generateContext});
